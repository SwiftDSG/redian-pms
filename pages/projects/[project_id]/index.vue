<template>
  <div class="rd-container">
    ...
    <rd-project-progress v-if="projectMenu === 'progress'" :project="project" :state="projectMenuState"
      @changing-done="projectMenuState = 'idle'" />
    <rd-project-timeline v-if="projectMenu === 'timeline'" :project="project" :state="projectMenuState"
      @changing-done="projectMenuState = 'idle'" />
    <rd-project-tasks v-if="projectMenu === 'tasks'" :project="project" :state="projectMenuState"

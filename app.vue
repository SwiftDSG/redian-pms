<template>
  <div class="rd-layout" ref="rdLayout">
    ...
    <rd-project-add-panel v-if="panelOpened === 'project-add'" :state="panelState" :data="panelData[0]"
    ...
    <rd-project-area-add-panel v-if="panelOpened === 'project-area-add'" :state="panelState" :data="panelData[0]"
      @exit="panelHandler({ state: 'hide' })" @open-panel="panelHandler" @change-page="changeHandler" />
    <rd-project-area-remove-panel v-if="panelOpened === 'project-area-remove'" :state="panelState" :data="panelData[0]"
      @exit="panelHandler({ state: 'hide' })" @open-panel="panelHandler" @change-page="changeHandler" />
    <rd-project-report-add-panel v-if="panelOpened === 'project-report-add'" :state="panelState" :data="panelData[0]"
      @exit="panelHandler({ state: 'hide' })" @open-panel="panelHandler" @change-page="changeHandler" />
    <rd-project-task-panel v-if="panelOpened === 'project-task'" :state="panelState" :data="panelData[0]"
      @exit="panelHandler({ state: 'hide' })" @open-panel="panelHandler" @change-page="changeHandler" />
    <rd-project-task-add-panel v-if="panelOpened === 'project-task-add'" :state="panelState" :data="panelData[0]"
      @exit="panelHandler({ state: 'hide' })" @open-panel="panelHandler" @change-page="changeHandler" />
    <rd-project-task-period-panel v-if="panelOpened === 'project-task-period'" :state="panelState" :data="panelData[0]"
      @exit="panelHandler({ state: 'hide' })" @open-panel="panelHandler" @change-page="changeHandler" />
  </div>
</template>

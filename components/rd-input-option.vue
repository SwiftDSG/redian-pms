<template>
  <div ref="rdInputComponent" class="rd-input-component" :class="props.input.error ? 'rd-input-error-active' : ''">
    ...
    <div class="rd-input-container">
      ...
      <input class="rd-input rd-body-text" :placeholder="props.input.placeholder" ref="rdInput" :name="props.input.name"
        :type="props.input.type" @focus="dropDownHandler('open')" @blur="dropDownHandler('close')" @keydown.up.prevent="
          selectIndex(
            dropDownIndex <= 0
    ...
    " @keypress.enter="selectOption" @input="updateModel" />
      <div class="rd-input-border"></div>
      <div ref="rdInputOptions" class="rd-input-options" :class="dropDownOpened ? 'rd-input-options-opened' : ''">
        <div class="rd-input-option rd-body-text" v-for="(option, i) in inputOptions" :key="i" @mouseover="selectIndex(i)"
          @mousedown="selectOption" :class="dropDownIndex === i ? 'rd-input-option-selected' : ''">

...
<script lang="ts" setup>
  ...
  onMounted(() => {
    if (props.data.role) {
      nameInput.value.model = props.data.role.name;
      ...
      rolePermission.value = rolePermission.value.map((a) => {
        ...
        if (
          (a.kind === "get_roles" &&
            props.data.role.permission.includes("get_roles") &&
            props.data.role.permission.includes("get_role")) ||
          (a.kind === "get_tasks" &&
            props.data.role.permission.includes("get_tasks") &&
            props.data.role.permission.includes("get_task")) ||
          (a.kind === "create_report" &&
            props.data.role.permission.includes("create_report") &&
            props.data.role.permission.includes("create_incident")) ||
          (a.kind !== "get_roles" &&
            a.kind !== "get_tasks" &&
            a.kind !== "create_report" &&
            props.data.role.permission.includes(a.kind))
        ) {
          permitted = true;
        }

<template>
  <rd-panel class="rd-panel" label="Add task" :state="panelState" :loading="loading" @exit="emits('exit')">
    ...
    <div class="rd-panel-footer">
      <rd-input-button class="rd-panel-button" label="submit" @clicked="submit"
